...
def uniform_crossover(parents): 
    ...
    offspring1 = parent1 * (section>=0.5) + parent2 * (section < 0.5)
    offspring2 = parent2 * (section>=0.5) + parent1 * (section < 0.5)
    # squeeze to get rid of the extra dimension created during parent selecting
...
def survivor_selection(population, population_fitness, population_size):
    ...
    #print('survivor indeces', survivor_indices)
    #print('len survivor indeces', len(survivor_indices))
    survivors = [population[i] for i in survivor_indices]
    survivor_fitnesses = [population_fitness[i] for i in survivor_indices]
...
for i in range(generations):
    ...
    for j in range(int(pop_size)):
        ...
        # print(parents)
        offspring_individual1 = uniform_crossover(parents)[0]
        offspring_individual2 = uniform_crossover(parents)[1]
        offspring_individual1 = uniform_mutate(offspring_individual1, mutation_rate)
        offspring_individual2 = uniform_mutate(offspring_individual2, mutation_rate)
        offspring.extend([offspring_individual1, offspring_individual2])
    ...
    pop, pop_fit = survivor_selection(offspring, offspring_fit, pop_size)
