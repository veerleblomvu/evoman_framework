...
experiment_name = 'aaa_osd_war2_1'
...
def evaluate(pop):
    ...
    """
    pop_fit_gain = np.array(list(map(lambda y: simulation(env,y), pop)))
    return pop_fit_gain
...
d = {"Run": indices, "gain": best_gain, "Best fit": best_fit, "Mean": mean_array, "STD": std_array}
